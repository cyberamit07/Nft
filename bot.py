...
from config import BOT_TOKEN, ADMIN_IDS, BOT_NAME, CHANNEL_NAME, CHANNEL_LINK, DEVELOPER, DEVELOPER_LINK, SUPPORTED_CURRENCIES, DATABASE_PATH
...
"""
            ...
            if deal:
                seller = db.get_user_by_username(deal[4])
                if seller:
                    db.update_rating(seller[0], rating_value)
            
            bot.answer_callback_query(call.id, f"⭐ Rated {rating_value}/5! Thank you!", show_alert=True)
            bot.edit_message_text(
                f"⭐ **Thank you for rating!**\n━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"You rated this deal {rating_value}/5 ⭐\n\n"
